...
public class clsBeBodega {
    ...
    @Element(required=false) public int IdPais;
    ...
    @Element(required=false) public boolean Reservar_stocks_por_linea;
    @Element(required=false) public boolean Rechazar_pedido_por_stock;
    @Element(required=false) public String IdTipoTransaccion;
    @Element(required=false) public double Zoom;
    @Element(required=false) public int IdMotivoUbicacionDanadoPicking;
    @Element(required=false) public boolean cambio_ubicacion_auto;
    @Element(required=false) public String codigo_bodega_erp;
    @Element(required=false) public int ubic_producto_ne;
    @Element(required=false) public int IdProductoEstadoNE;
