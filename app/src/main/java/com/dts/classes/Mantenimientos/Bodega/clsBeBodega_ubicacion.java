...
public class clsBeBodega_ubicacion {
    ...
    @Element(required=false) public boolean Ubicacion_Virtual;
    ...
    @Element(required=false) public double ubicacion_ne;
    ...
    @Element(required=false) public String NombreCompleto=new String();
