...
public class clsBeProducto_Presentacion {
    ...
    @Element(required=false) public boolean Imprime_barra;
    ...
    @Element(required=false) public double MinimoExistencia;
    @Element(required=false) public double MaximoExistencia;
    ...
    @Element(required=false) public double MinimoPeso;
    @Element(required=false) public double MaximoPeso;
    @Element(required=false) public double Costo;
    @Element(required=false) public double CamasPorTarima;
    @Element(required=false) public double CajasPorCama;
    @Element(required=false) public boolean Genera_lp_auto;
    @Element(required=false) public boolean Permitir_paletizar;
    @Element(required=false) public boolean Sistema;
    @Element(required=false) public int IdPresentacionPallet;
    @Element(required=false) public boolean IsNew;
    @Element(required=false) public boolean ExisteStock;
