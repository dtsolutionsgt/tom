...
public class clsBeProducto_parametro_b {
    ...
    public clsBeProducto_parametro_b(int IdProductoParametroB,String Codigo,String Nombre,String User_agr,
                                     String Fec_agr,String Fec_mod,String User_mod,boolean Activo
    ) {

        this.IdProductoParametroB=IdProductoParametroB;
        this.Codigo=Codigo;
        this.Nombre=Nombre;
