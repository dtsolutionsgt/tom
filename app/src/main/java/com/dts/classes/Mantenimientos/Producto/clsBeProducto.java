...
public class clsBeProducto {
  ...
  @Element(required=false) public int IdCamara;
  @Element(required=false) public int IdTipoRotacion;
  @Element(required=false) public int IdPerfilSerializado;
  @Element(required=false) public int IdIndiceRotacion;
  @Element(required=false) public int IdSimbologia;
  ...
  @Element(required=false) public double Existencia_min;
  @Element(required=false) public double Existencia_max;
  @Element(required=false) public double Costo;
  @Element(required=false) public double Peso_referencia;
  @Element(required=false) public double Peso_tolerancia;
  @Element(required=false) public double Temperatura_referencia;
  @Element(required=false) public double Temperatura_tolerancia;
  @Element(required=false) public boolean Activo;
  @Element(required=false) public boolean Serializado;
  @Element(required=false) public boolean Genera_lote;
  @Element(required=false) public boolean Genera_lp;
  @Element(required=false) public boolean Control_vencimiento;
  @Element(required=false) public boolean Control_lote;
  @Element(required=false) public boolean Peso_recepcion;
  @Element(required=false) public boolean Peso_despacho;
  @Element(required=false) public boolean Temperatura_recepcion;
  @Element(required=false) public boolean Temperatura_despacho;
  @Element(required=false) public boolean Materia_prima;
  @Element(required=false) public boolean Kit;
  @Element(required=false) public int Tolerancia;
  @Element(required=false) public int Ciclo_vida;
  ...
  @Element(required=false) public boolean Capturar_aniada;
  @Element(required=false) public boolean Control_peso;
  @Element(required=false) public boolean Captura_arancel;
  @Element(required=false) public boolean Es_hardware;
  ...
  @Element(required=false) public int IdPresentacionOrigen;
  @Element(required=false) public int IdPresentacionDestino;
  ...
  public clsBeProducto(int IdProducto,int IdPropietario,int IdClasificacion,int IdFamilia,
                       ...
                       String Lote,String FechaVence,double Cantidad) {
