...
public class clsBeTrans_re_det {
    ...
    @Element(required=false) public double Peso_Minimo;
    @Element(required=false) public double Peso_Maximo;
    @Element(required=false) public double peso_unitario;
    @Element(required=false) public String User_agr;
    @Element(required=false) public String Fec_agr="1900-01-01T00:00:01";
    @Element(required=false) public String Observacion;
    @Element(required=false) public int Aniada;
    @Element(required=false) public double Costo;
    @Element(required=false) public double Costo_Oc;
    @Element(required=false) public double Costo_Estadistico;
    ...
    @Element(required=false) public int IdUbicacionAnterior;
    @Element(required=false) public int IdOrdenCompraEnc;
    @Element(required=false) public String Fecha_Rec;
    ...
    public clsBeTrans_re_det(int IdPresentacion,int IdUnidadMedida,int IdProductoEstado,int IdMotivoDevolucion,
                             ...
                             String Lic_plate,double Uds_lic_plate) {
