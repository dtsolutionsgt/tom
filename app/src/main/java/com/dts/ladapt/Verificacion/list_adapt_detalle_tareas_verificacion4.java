    ...
    public View getView(int position, View convertView, ViewGroup pListBeTareasVerificacionHH) {
        ...
        try{
            ...
            if (convertView == null) {
                ...
                holder.relLote  = convertView.findViewById(R.id.relLote);
                holder.relVence = convertView.findViewById(R.id.relVence);
                ...
                holder.txtVerificado = convertView.findViewById(R.id.txtVerificado);
