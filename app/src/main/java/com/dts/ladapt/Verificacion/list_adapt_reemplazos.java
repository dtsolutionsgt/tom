...
public class list_adapt_reemplazos extends BaseAdapter {
    ...
    public list_adapt_reemplazos(Context context, ArrayList<clsBeDetallePedidoAVerificar> results) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try{
            list_adapt_detalle_tareas_verificacion.ViewHolder holder;

            if (convertView == null) {
                convertView = l_Inflater.inflate(R.layout.activity_list_adapt_detalle_tareas_verificacion, null);
                holder = new list_adapt_detalle_tareas_verificacion.ViewHolder();
                ...
                holder = (list_adapt_detalle_tareas_verificacion.ViewHolder) convertView.getTag();
            }
    ...
    static class ViewHolder {
        TextView lblPedidoEnc,lblPedidoDet,lblCodigo,lblProducto,lblLote,lblVence,lblLicPlate,lblUmBas,lblPresentacion,
                lblSolicitado,lblPickeado, lblVerificado, lblEstado, lblIdPresentacion, lblIdProductoBodega,
                lblEPedidoEnc,lblEPedidoDet, lblEIdPresentacion, lblEIdProductoBodega;
    }
