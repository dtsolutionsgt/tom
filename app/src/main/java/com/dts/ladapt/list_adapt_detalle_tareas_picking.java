...
public class list_adapt_detalle_tareas_picking extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (position==0){
            ...
            holder.lblProductoDet.setText("Producto");
            holder.lblProductoDet.setTextColor(R.style.titlestyle);
            holder.lblUmbasDet.setText("UmBas");
            holder.lblUmbasDet.setTextColor(R.style.titlestyle);
            holder.lblPresDet.setText("Presentación");
            ...
            holder.lblLoteDet.setTextColor(R.style.titlestyle);
            holder.lblLpDet.setText("LP");
            holder.lblLpDet.setTextColor(R.style.titlestyle);
            holder.lblVenceDet.setText("Expira");
            holder.lblVenceDet.setTextColor(R.style.titlestyle);
            holder.lblNomEstadoDet.setText("NomEstado");
            holder.lblNomEstadoDet.setTextColor(R.style.titlestyle);
            holder.lblPesoDet.setText("Peso");
            holder.lblPesoDet.setTextColor(R.style.titlestyle);
            holder.lblIdPresDet.setText("IdPresentacion");
            holder.lblIdPresDet.setTextColor(R.style.titlestyle);
            holder.lblIdEstadoDet.setText("IdEstado");
            holder.lblIdEstadoDet.setTextColor(R.style.titlestyle);
            holder.lblIdPedidoEnc.setText("IdPedidoEnc");
            holder.lblIdPedidoEnc.setTextColor(R.style.titlestyle);
            holder.lblPedidoDet.setText("IdPedidoDet");
            holder.lblPedidoDet.setTextColor(R.style.titlestyle);
            holder.lblIdPickingDet.setText("IdPickingDet");
            holder.lblIdPickingDet.setTextColor(R.style.titlestyle);
            holder.lblProductoBodegaDet.setText("IdProductoBodega");
            holder.lblProductoBodegaDet.setTextColor(R.style.titlestyle);
            holder.lblPickingUbic.setText("IdPickingUbic");
            holder.lblPickingUbic.setTextColor(R.style.titlestyle);
            holder.lblStock.setText("IdStock");
            holder.lblStock.setTextColor(R.style.titlestyle);
            holder.lblStockRes.setText("IdStockRes");
            holder.lblStockRes.setTextColor(R.style.titlestyle);
