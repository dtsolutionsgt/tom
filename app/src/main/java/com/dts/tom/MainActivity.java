        ...
        spinbod.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id)
            {
                try
                {
                    ...
                    gl.Permitir_Verificacion_Consolidada = bodegas.items.get(position).Permitir_Verificacion_Consolidada;
                    ...
                    gl.Control_Talla_Color = bodegas.items.get(position).Control_Talla_Color;
